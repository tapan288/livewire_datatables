function strlen(e) {
    ...
    var i = function(e, t) {
        ...
        if (55296 <= a && a <= 56319) {
            ...
            if (((r = e.charCodeAt(t + 1)), 56320 > r || r > 57343))
                throw "High surrogate without following low surrogate";
            return e.charAt(t) + e.charAt(t + 1);
        }
        if (56320 <= a && a <= 57343) {
            if (0 === t) throw "Low surrogate without preceding high surrogate";
            if (((n = e.charCodeAt(t - 1)), 55296 > n || n > 56319))
                throw "Low surrogate without preceding high surrogate";
            return !1;
        }
        return e.charAt(t);
    };
    for (a = 0, n = 0; a < t.length; a++) (r = i(t, a)) !== !1 && n++;
    return n;
}
function array_diff(e) {
    ...
    e: for (r in e)
        for (n = 1; n < a; n++) {
            s = arguments[n];
            for (i in s) if (s[i] === e[r]) continue e;
            t[r] = e[r];
        }
    return t;
}
function strtotime(e, t) {
    ...
    function r(e) {
        ...
        if (
            (i && (o *= parseInt(r, 10)),
            d.hasOwnProperty(n) && !t[1].match(/^mon(day|\.)?$/i))
        )
            return l["set" + d[n]](l["get" + d[n]]() + o);
        if ("wee" === n) return l.setDate(l.getDate() + 7 * o);
        if ("next" === r || "last" === r) a(r, n, o);
        else if (!i) return !1;
        return !0;
    }
    var n,
    ...
    if (
        ...
        if (i[1] > 1901)
            ...
            switch (i[2]) {
                case "-":
                    return i[3] > 12 || i[5] > 31 || (i[1] < 70 && i[1] > 38)
                        ? g
                        : ((o = i[1] >= 0 && i[1] <= 38 ? +i[1] + 2e3 : i[1]),
                          new Date(
                              o,
                              parseInt(i[3], 10) - 1,
                              i[5],
                ...
                case ".":
                    return i[5] >= 70
                        ...
                        : g;
                case "/":
                    return i[1] > 12 || i[3] > 31 || (i[5] < 70 && i[5] > 38)
                        ? g
                        : ((o = i[5] >= 0 && i[5] <= 38 ? +i[5] + 2e3 : i[5]),
                          new Date(
                              o,
                              parseInt(i[1], 10) - 1,
                              i[3],
    ...
    if (
        ...
        ("z" == i[4]
            ? (i[4] = "Z")
            : i[4].match(/^([\+-][0-9]{2})$/) && (i[4] = i[4] + ":00"),
        !isNaN((n = Date.parse(i[1] + "T" + i[2] + i[4]))))
    )
        return (n / 1e3) | 0;
    if (
        ((l = t ? new Date(1e3 * t) : new Date()),
        ...
        (m = "([+-]?\\d+\\s" + c + "|(last|next)\\s" + c + ")(\\sago)?"),
        (i = e.match(new RegExp(m, "gi"))),
        !i)
    )
        return g;
    for (f = 0, h = i.length; f < h; f++) if (!r(i[f])) return g;
...
function is_numeric(e) {
    ...
    return (
        ("number" == typeof e ||
            ("string" == typeof e && t.indexOf(e.slice(-1)) === -1)) &&
        "" !== e &&
        !isNaN(e)
    );
}
                      ...
                      this.on("submit.validate", function(t) {
                          function r() {
                              ...
                              return (
                                  ...
                                  (n = a.settings.submitHandler.call(
                                      a,
                                      a.currentForm,
                                      t
                                  )),
                                  a.submitButton && r.remove(),
                                  void 0 !== n && n)
                              );
                          }
                          return (
            ...
            prototype: {
                ...
                showErrors: function(t) {
                    if (t) {
                        ...
                        this.successList = e.grep(this.successList, function(
                            e
                        ) {
                            return !(e.name in t);
                        });
                ...
                elementValue: function(t) {
                    ...
                    return "radio" === n || "checkbox" === n
                        ...
                        ? !t.validity.badInput && r.val()
                        : ((a = r.val()),
                          "string" == typeof a ? a.replace(/\r/g, "") : a);
                },
                check: function(t) {
                    ...
                    for (r in i) {
                        n = { method: r, parameters: i[r] };
                        try {
                            if (
                                ((a = e.validator.methods[r].call(
                                    this,
                                    l,
                                    t,
                                    n.parameters
                                )),
                                "dependency-mismatch" === a && 1 === s)
                            ) {
                                o = !0;
                                continue;
                            }
                ...
                for (a in e.validator.methods)
                    "required" === a
                        ? ((r = t.getAttribute(a)),
                          ...
                          (r = !!r))
                        : (r = i.attr(a)),
                        this.normalizeAttributeRule(n, s, a, r);
                return (
                    n.maxlength &&
                ...
                remote: function(t, a, r) {
                    ...
                    return (
                        this.settings.messages[a.name] ||
                            (this.settings.messages[a.name] = {}),
                        (s.originalMessage = this.settings.messages[
                            a.name
                        ].remote),
...
!(function() {
    ...
    (i = 864e5),
        ...
        (t = function(e, a, r) {
            var n = e.toString();
            return (r = r || "0"), n.length < a ? t(r + n, a) : n;
        }),
        (a = function(e) {
            var t, r;
        ...
        (DateFormatter.prototype = {
            ...
            getMonth: function(e) {
                ...
                return (
                    ...
                    0 === t && (t = r(e, a.dateSettings.months) + 1),
                    t
                );
            },
            parseDate: function(t, a) {
                ...
                if ("U" === a)
                    return (i = parseInt(t)), i ? new Date(1e3 * i) : t;
                switch (typeof t) {
                    case "number":
                        return new Date(t);
                    case "string":
                ...
                for (
                    n = t.replace(m.separators, "\0").split("\0"), i = 0;
                    i < n.length;
                    i++
                )
                    switch (((s = n[i]), (o = parseInt(s)), r[i])) {
                        case "y":
                        case "Y":
                            if (!o) return null;
                            (h = s.length),
            ...
            guessDate: function(e, t) {
                ...
                for (n = 0; n < u.length; n++) {
                    ...
                    (i = s.substr(m)), i.length > 0 && u.splice(n + 1, 0, i);
                }
                return c;
            },
            parseFormat: function(e, a) {
                ...
                return (
                    (r = {
                        ...
                        T: function() {
                            var e = (String(a).match(n.tzParts) || [""])
                                .pop()
                                .replace(n.tzClip, "");
                            return e || "UTC";
                        },
            ...
            formatDate: function(e, t) {
                var a,
                    ...
                    l = "",
                    u = "\\";
                if ("string" == typeof e && ((e = o.parseDate(e, t)), !e))
                    return null;
...
(laravelValidation = {
    ...
    arrayRules: function(e) {
        ...
        return e.name.indexOf("[") === -1
            ? t
            : (e.name in r || (r[e.name] = {}),
              $.each(a.settings.rules, function(a, n) {
                  if (a in r[e.name]) $.extend(t, r[e.name][a]);
                  else {
                      r[e.name][a] = {};
                      var i = laravelValidation.helpers.regexFromWildcard(a);
                      if (e.name.match(i)) {
                          var s = $.validator.normalizeRule(n) || {};
                          (r[e.name][a] = s), $.extend(t, s);
                      }
                  }
              }),
              t);
        ...
        $.validator.addMethod(
            ...
            function(e, t, a) {
                ...
                return (
                    $.each(a, function(e, t) {
                        t[3] ||
                        laravelValidation.implicitRules.indexOf(t[0]) !== -1
                            ? s.unshift(t)
                            : s.push(t);
                    }),
                    $.each(s, function(a, s) {
                                  ...
                                  laravelValidation.methods[l].call(
                                      ...
                                      function(a) {
                                          if (
                                              ...
                                              var n = r.formSubmitted;
                                              r.prepareElement(t),
                                                  (r.formSubmitted = n),
                                                  r.successList.push(t),
                                                  delete r.invalid[t.name],
                                                  r.showErrors();
                                          } else {
                                              var s = {};
                                              (s[
                                                  t.name
                                              ] = i.message = $.isFunction(u)
                                                  ? u(e)
                                                  : u),
                                                  (r.invalid[t.name] = !0),
                                                  r.showErrors(s);
                                          }
                                          r.showErrors(r.errorMap),
                                              (i.valid = a);
                                      }
                                  )),
                              n !== !0
                                  ? (r.settings.messages[t.name] ||
                                        (r.settings.messages[t.name] = {}),
                                    (r.settings.messages[
                                        t.name
                                    ].laravelValidation = u),
            ...
            $.validator.addMethod(
                ...
                function(e, t, a) {
                    ...
                    var l,
                        u,
                        d = this.previousValue(t);
                    this.settings.messages[t.name] ||
                        (this.settings.messages[t.name] = {}),
                        (d.originalMessage = this.settings.messages[
                            t.name
                        ].laravelValidationRemote),
                        (this.settings.messages[
                            t.name
                        ].laravelValidationRemote = d.message);
                    var h = ("string" == typeof h && { url: h }) || h;
                    if (
                        laravelValidation.helpers.arrayEquals(d.old, e) ||
                        d.old === e
                    )
                        return d.valid;
                    (d.old = e),
                        (l = this),
                        this.startRequest(t),
                        (u = $(l.currentForm).serializeArray()),
                        u.push({ name: "_jsvalidation", value: i }),
                        u.push({
                    ...
                    return (
                        $(l.currentForm).find('input[name="_method"]').length &&
                            (c = $(l.currentForm)
                        ...
                        $.ajax(
                            ...
                            if ("error" === r)
                                (o = !1),
                                    (a = laravelValidation.helpers.parseErrorResponse(
                                        a
                                    ));
                            else {
                                if ("success" !== r) return;
                            ...
                            (l.settings.messages[
                                t.name
                            ].laravelValidationRemote = d.originalMessage),
                                o
                                    ? ((s = l.formSubmitted),
                                      l.prepareElement(t),
                                      (l.formSubmitted = s),
                                      l.successList.push(t),
                                      delete l.invalid[t.name],
                                      l.showErrors())
                                    : ((n = {}),
                                      (i = a || l.defaultMessage(t, "remote")),
                                      (n[t.name] = d.message = $.isFunction(i)
                                          ? i(e)
                                          : i[0]),
                                      (l.invalid[t.name] = !0),
                                      l.showErrors(n)),
                                l.showErrors(l.errorMap),
                                (d.valid = o),
                                l.stopRequest(t, o);
                        }),
                        "pending"
        ...
        helpers: {
            ...
            hasRules: function(e, t) {
                ...
                return (
                    ...
                    e.name in r.settings.rules &&
                        n.push(r.settings.rules[e.name]),
                    $.each(n, function(e, r) {
                        if ("laravelValidation" in r)
                            for (
                                var n = r.laravelValidation, i = 0;
                                i < n.length;
                                i++
                            )
                                if ($.inArray(n[i][0], t) !== -1)
                                    return (a = !0), !1;
                    }),
                    a
                );
            ...
            getLaravelValidation: function(e, t) {
                var a = void 0;
                return (
                    $.each($.validator.staticRules(t), function(t, r) {
                        "laravelValidation" === t &&
                            $.each(r, function(t, r) {
                                r[0] === e && (a = r);
                            });
            ...
            parseTime: function(e, t) {
                var a = !1,
                    r = new DateFormatter();
                if ("object" === $.type(t)) {
                    var n = this.getLaravelValidation("DateFormat", t);
                    t = void 0 !== n ? n[1][0] : null;
                }
                return (
                    null == t
                        ? (a = this.strtotime(e))
                        : ((a = r.parseDate(e, t)),
                          a && (a = Math.round(a.getTime() / 1e3))),
                    a
                );
            },
            guessDate: function(e, t) {
        ...
        helpers: {
            isTimezone: function(e) {
                var t = {
                    ...
                    n = "";
                return (
                    a[1] && (n = a[1].toLowerCase()),
                    r in t && (0 === t[r].length || t[r].indexOf(n) !== -1)
                );
            }
        }
    }),
    $.extend(!0, laravelValidation, {
        methods: {
            ...
            RequiredIf: function(e, t, a) {
                ...
                if (void 0 !== r) {
                    var n = String(this.elementValue(r));
            ...
            Same: function(e, t, a) {
                ...
                return (
                    void 0 !== r && String(e) === String(this.elementValue(r))
                );
            },
            InArray: function(e, t, a) {
                if ("undefined" == typeof a[0]) return !1;
                for (
                    var r = this.elements(),
                        n = !1,
            ...
            Mimes: function(e, t, a) {
                ...
                var r = $.map(a, function(e) {
                    ...
                    n = laravelValidation.helpers.fileinfo(t);
                return n !== !1 && r.indexOf(n.extension.toLowerCase()) !== -1;
            },
            Mimetypes: function(e, t, a) {
                ...
                var r = $.map(a, function(e) {
                    ...
                    n = laravelValidation.helpers.fileinfo(t);
                return n !== !1 && r.indexOf(n.type.toLowerCase()) !== -1;
            },
            Image: function(e, t) {
            ...
            Dimensions: function(value, element, params, callback) {
                ...
                if (
                    null === element.files ||
                    "undefined" == typeof element.files[0]
                )
                    return !1;
            ...
            Before: function(e, t, a) {
                ...
                if (isNaN(r)) {
                    ...
                    r = laravelValidation.helpers.parseTime(
                        this.elementValue(n),
                        n
                    );
                }
